...
together (local-dev/tests/reference-render.py) and nobody looked for a third copy.
...
Discovered by `python3 -m unittest discover local-dev` — the mechanization is the
