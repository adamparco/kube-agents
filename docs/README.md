...
| `docs/talks/kubecon-eu-2027-cfp.md` | Conference submission | Draft CFP for KubeCon + CloudNativeCon Europe 2027: the three submission fields with measured character counts, the project list, a 30-minute outline, and the numbers each claim rests on. | Session title/description/benefits, track choice, outline, Q&A defences | Draft; CFP closes 11 October 2026 |
