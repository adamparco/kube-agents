...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| A Python module's own logic                                                                | beside the module; the exact directory set is the `PYTHON_TEST_DIRS` globs at `Makefile:140-155` | `make test-python`                                                                                                                              | runs, unconditionally                                                                                             |
...
the branch-protection half of the set. `make verify` (`Makefile:184`) is the
...
`PYTHON_TEST_DIRS`, a list of fifteen globs at `Makefile:140-155`. A directory the globs miss fails
