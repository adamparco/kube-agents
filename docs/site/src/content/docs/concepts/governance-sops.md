...
The six audit jobs preload the skill through their cron entry (`"skills": ["fleet-audit"]`). The disabled governance jobs still ship with `"skills": []`.
