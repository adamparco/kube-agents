...
3. It opens a Pull Request against your GitOps repository. `fleet-audit` keeps one PR per audit stream and rewrites it in place rather than opening a new one each run.
