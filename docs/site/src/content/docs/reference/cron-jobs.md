...
| `gce-compute-fleet-audit` | Platform Agent | `45 7 * * *` | — | yes | Run the daily GCE Compute Engine and MIG fleet audit. Run the collector (`skills/gce-compute-fleet-audit/sc... |
