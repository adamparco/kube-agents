...
| -- | -------- | ------- | :-----: | ---------- |
| `profile-cron-tick` | `every 1m` | — | yes | `profile_cron_tick.py` |
...
| `schedule.kind`    | string          | `"cron"` for the seven watchdogs; `profile-cron-tick` and the two onboarding jobs use `"interval"`.                                                                                                                                                        |
