...
| Current task         | T1/T2/T4/T5/T6/T7 done (read-only render + no runtime RBAC/KSA mint + pre-created identity + CRD fields). Next: T8 ((tier,scope) cardinality + tier immutability + non-empty-allowlist CEL), then T9 (cloud GSA viewer-only), T3 (retire create_cluster), T10–T12. |
| Overall              | ✅ Phase 0 **merged to `main`**; 🟡 Phase 1 in progress — 6/12 tasks committed on `phase-1-readonly-platform-agent` (pushed to fork)                                                                                                                               |
...
| Last updated         | 2026-07-24 — T4/T5 committed (`5ca0746`): controller mints no RBAC/SA, `role.yaml` downgraded; golden + unit tests green; branch pushed to fork                                                                                                                    |
| Last updated by      | harness-run (Phase 1 T4/T5)                                                                                                                                                                                                                                        |
